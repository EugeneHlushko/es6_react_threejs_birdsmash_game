...
THREE.GPUParticleSystem = function(options) {
  ...
  let perlinPicture = require('images/textures/particles/perlin-512.png');
  let particlePicture = require('images/textures/particles/particle2.png');
  perlinPicture = perlinPicture.substring(perlinPicture.indexOf('/assets/'));
  particlePicture = particlePicture.substring(particlePicture.indexOf('/assets/'));
  ...
  self.particleNoiseTex = textureLoader.load(perlinPicture);
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = textureLoader.load(particlePicture);
